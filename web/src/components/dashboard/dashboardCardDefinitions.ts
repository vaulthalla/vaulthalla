...
export const dashboardCardDefinitions: DashboardCardDefinition[] = [
  ...
  },
  {
    ...
    sectionId: 'cost_control',
    title: 'S3 Price Budget Overview',
    description: 'Active policies, blocked syncs, warnings, monthly spend, and projection.',
    href: '/pricing-budget',
    defaultVariant: 'tiles',
    defaultSize: '2x1',
    supportedSizes: tilesSizes,
    supportedVariants: ['tiles'],
    metricPriority: ['blocked_syncs', 'critical', 'warnings', 'active_policies', 'monthly_spend', 'projected_monthly', 'pending_overrides'],
    zeroLowValueMetricKeys: ['blocked_syncs', 'critical', 'warnings', 'pending_overrides'],
    variants: { tiles: { supportedSizes: tilesSizes } },
  },
  {
    id: 'system.pricing_providers',
    sectionId: 'cost_control',
    title: 'Provider Spend',
    description: 'AWS S3 and Cloudflare R2 spend against active provider budgets.',
    href: '/pricing-budget',
    defaultVariant: 'tiles',
    defaultSize: '2x1',
    supportedSizes: tilesSizes,
    supportedVariants: ['tiles'],
    metricPriority: ['aws-s3_current', 'aws-s3_projected', 'cloudflare-r2_current', 'cloudflare-r2_projected', 'provider_policies'],
    zeroLowValueMetricKeys: ['provider_policies'],
    variants: { tiles: { supportedSizes: tilesSizes } },
  },
  {
    ...
    supportedSizes: tilesSizes,
    supportedVariants: ['tiles'],
    metricPriority: ['tracked_vaults', 'top_spend', 'projected_overage_vaults', 'top_vault'],
    zeroLowValueMetricKeys: ['tracked_vaults', 'projected_overage_vaults'],
    variants: { tiles: { supportedSizes: tilesSizes } },
  },
  {
    ...
    supportedSizes: tilesSizes,
    supportedVariants: ['tiles'],
    metricPriority: ['critical', 'warnings', 'unacknowledged', 'active_alerts'],
    zeroLowValueMetricKeys: ['critical', 'warnings', 'unacknowledged', 'active_alerts'],
    variants: { tiles: { supportedSizes: tilesSizes } },
  },
  {
    ...
    description: 'Verified catalog state, staleness, refresh age, and provider coverage.',
    href: '/pricing-budget',
    defaultVariant: 'tiles',
    defaultSize: '2x1',
    supportedSizes: tilesSizes,
    supportedVariants: ['tiles'],
    metricPriority: ['catalog_issues', 'stale', 'unverified', 'unsupported'],
    zeroLowValueMetricKeys: ['catalog_issues', 'stale', 'unverified', 'unsupported'],
    variants: { tiles: { supportedSizes: tilesSizes } },
  },
  {
    id: 'system.pricing_overrides',
    sectionId: 'cost_control',
    title: 'Recent Blocks and Overrides',
    description: 'Blocked syncs plus pending, approved, and denied override requests.',
    href: '/pricing-budget',
    defaultVariant: 'tiles',
    defaultSize: '2x1',
    supportedSizes: tilesSizes,
    supportedVariants: ['tiles'],
    metricPriority: ['blocked_syncs', 'pending', 'approved', 'denied', 'used'],
    zeroLowValueMetricKeys: ['blocked_syncs', 'pending', 'approved', 'denied', 'used'],
    variants: { tiles: { supportedSizes: tilesSizes } },
  },
  {
    id: 'system.trends',
...
export const dashboardLayoutPresetDefinitions: DashboardLayoutPresetDefinition[] = [
  ...
  },
  {
    id: 'cost_control',
    title: 'Cost Control',
    description: 'S3 budget policies, local spend projection, alerts, and override posture.',
    cards: [
      { id: 'system.pricing_budget', size: '2x1', variant: 'tiles' },
      { id: 'system.pricing_alerts', size: '2x1', variant: 'tiles' },
