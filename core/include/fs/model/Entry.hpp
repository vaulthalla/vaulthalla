...
namespace vh::fs::model {
    ...
    struct Entry {
        ...
        std::optional<int32_t> parent_id{}, owner_uid{}, group_gid{}, vault_id{}, created_by{}, last_modified_by{};
    ...
    std::unordered_map<std::u8string, std::shared_ptr<Entry> > groupEntriesByPath(
