...
from tools.release.changelog.ai.config import DEFAULT_AI_POLISH_MODEL
...
def run_polish_stage(
    ...
    *,
    ...
    active_provider = provider or OpenAIProvider(model=model or DEFAULT_AI_POLISH_MODEL)
